...
public class RolePermission implements Serializable {
    ...
    @Column(columnName = "role_permission_id", jdbcType = JdbcType.BIGINT, comment = "主键ID", isPrimaryKey = true, isNull = false)
    private Long rolePermissionId;

    @Column(columnName = "role_id", jdbcType = JdbcType.BIGINT, comment = "角色Id")
    private Long roleId;

    @Column(columnName = "permission_id", jdbcType = JdbcType.BIGINT, comment = "权限Id")
